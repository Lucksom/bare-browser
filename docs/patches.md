...
| 0100 | Restore vertical stack tab switcher | Adds Settings option in Tabs to switch from modern tab groups back to pre-Chromium 88 3D stacked cards without tab groups |
